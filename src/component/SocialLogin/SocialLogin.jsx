...
const SocialLogin = () => {
    ...
    return (
        ...
        <div>
            ...
            <div onClick={handleGoogleSignIn} className="flex items-center bg-green-300 justify-center mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
